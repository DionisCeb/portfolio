...
import DarkPhoneScreen from "../components/DarkPhoneScreen";
const Contact = () => {
        ...
        <section className="my-20 w-full pt-[100px] pb-[100px]" id="contact">
            ...
            <DarkPhoneScreen>
                <div className=" min-h-screen flex items-center justify-center flex-col">
                    {/* <img src="/assets/img/contact/phone.png" alt="terminal background" className="absolute inset-0 min-h-screen hidden xs1:block w-full"/> */}
